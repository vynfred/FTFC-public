...
/**
 * TermsContent component for editing the terms of service page content
 */
const TermsContent = ({ data, onFieldChange, onArrayFieldChange, onAddArrayItem, onRemoveArrayItem }) => {
  ...
  return (
    <div className="content-section">
      ...
      <ContentSection title="Terms Sections">
        <ArrayField 
          name="sections"
          items={data.sections || []}
          onAdd={addSection}
