    ...
    <div className="services-page">
      <section className="page-header">
        <div className="container">
          ...
          <p className="page-subtitle">Comprehensive financial solutions for businesses at every stage.</p>
        </div>
      </section>
      ...
      <section className="services-overview">
        <div className="container">
          <div className="services-grid">
            <div className="service-card" id="startup-funding">
              <div className="service-icon">🚀</div>
              <h2 className="service-title">Startup Funding</h2>
              ...
              <Link to="/consultation" className="service-button">Get Started</Link>
            </div>
            
            <div className="service-card" id="business-loans">
              <div className="service-icon">💼</div>
              <h2 className="service-title">Business Loans</h2>
              <p className="service-description">
                Access a variety of business loan options tailored to your specific needs. We work with traditional banks, online lenders, and alternative financing sources to find the best terms for your business.
              </p>
              <ul className="service-features">
                <li>SBA loans with competitive rates</li>
                <li>Term loans for established businesses</li>
                <li>Equipment financing and leasing</li>
                <li>Working capital and line of credit solutions</li>
              </ul>
              <Link to="/consultation" className="service-button">Get Started</Link>
            </div>
            
            <div className="service-card" id="venture-capital">
              <div className="service-icon">📈</div>
              <h2 className="service-title">Venture Capital</h2>
              <p className="service-description">
            ...
            <div className="service-card" id="financial-consulting">
              <div className="service-icon">📊</div>
            ...
            <div className="service-card" id="investment-strategies">
              <div className="service-icon">💰</div>
              <h2 className="service-title">Investment Strategies</h2>
              <p className="service-description">
            ...
            <div className="service-card" id="merger-acquisition">
              <div className="service-icon">🤝</div>
              <h2 className="service-title">Merger & Acquisition</h2>
              <p className="service-description">
